...
<div class="py-5">
	...
	<h5  id="heading" class="text-center p-2">DE-COMPRESS</h5>
    <hr>
	<div class="bigdiv">
		...
		<div class="align mt-5 mb-5" id="step2">
			...
			<button type="button" id="encode" class="button btn btn-dark col-md-12" style="display: none;" >COMPRESS</button>
			
			<button type="button" id="decode" class="button btn btn-dark col-md-12"  >DE-COMPRESS</button>
