       ...
       <div class="form-group mt-4">
        ...
        <label>Password</label>
         <input type="password" name="password" class="form-control ">
          ...
          <span class="text-center  text-secondary mt-5" style="font-size:1em; margin-left:70px;">Already registered? <a href="login.php" class="mt-2 text-decoration-none">Click here</a></span> 
